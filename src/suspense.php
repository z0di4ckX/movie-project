...
<body>
    ...
    <main>
        ...
        <a href="scienceFiction.php" class="buttom-right btn btn-outline-primary rounded-pill">Next</a>
        <a href="horror.php" class="buttom-left  btn btn-outline-primary rounded-pill">Back</a>
    </main>
