<?php 
    ...
    $query = "SELECT id_pelicula, titulo, poster,categoria  FROM pelicula WHERE categoria = 2";
...
<body>
    ...
    <div class="title">
        <h1 class="main_title">Suspense</h1>
        <hr>
    </div>
    <main>
        <!-- Section 1 -->
        ...
        <a href="scienceFiction.php" class="buttom-right btn btn-outline-primary rounded-pill mb-3">Next</a>
        <a href="horror.php" class="buttom-left  btn btn-outline-primary rounded-pill mb-3">Back</a>
    </main>
