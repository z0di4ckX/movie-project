...
<body>
    ...
    <main>
        ...
        <a href="adventure.php" class="buttom-right btn btn-outline-primary rounded-pill">Next</a>
        <a href="action.php" class="buttom-left  btn btn-outline-primary rounded-pill">Back</a>
    </main>
