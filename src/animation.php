<?php 
    ...
    $query = "SELECT id_pelicula, titulo, poster,categoria  FROM pelicula WHERE categoria = 6";
...
<body>
    ...
    <div class="title">
        <h1 class="main_title">Animation</h1>
        <hr>
    </div>
    <main>
        <!-- Section 1 -->
        ...
        <a href="comedy.php" class="buttom-right btn btn-outline-primary rounded-pill mb-3">Next</a>
