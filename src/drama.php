<?php 
    ...
    $query = "SELECT id_pelicula, titulo, poster,categoria  FROM pelicula WHERE categoria = 9";
...
<body>
    ...
    <main>
        ...
        <a href="comedy.php" class="buttom-left  btn btn-outline-primary rounded-pill mb-3">Back</a>
    </main>
