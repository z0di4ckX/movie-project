<?php 
    ...
    $query = "SELECT id_pelicula, titulo, poster,categoria  FROM pelicula WHERE categoria = 5";
...
<body>
    ...
    <main>
        ...
        <a href="suspense.php" class="buttom-right btn btn-outline-primary rounded-pill mb-3">Next</a>
        <a href="animation.php" class="buttom-left  btn btn-outline-primary rounded-pill mb-3">Back</a>
    </main>
