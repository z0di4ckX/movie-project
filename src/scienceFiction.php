...
<body>
    ...
    <main>
        ...
        <a href="romance.php" class="buttom-right btn btn-outline-primary rounded-pill mb-3">Next</a>
        <a href="suspense.php" class="buttom-left  btn btn-outline-primary rounded-pill mb-3">Back</a>
    </main>
